...
# Compiles both projects and stages output into Modules/M365DSC.mgx/ directory
...
$ModuleRoot = Join-Path $PSScriptRoot 'Modules' 'M365DSC.mgx'
...
Write-Host "  Import-Module '$ModuleRoot/M365DSC.mgx.psd1'" -ForegroundColor White
