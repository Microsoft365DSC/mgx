...
#pragma warning restore CS8714
                    ...
                    // excluded, matching where the owned client measures it. On this path the SDK
                    // retry handler sleeps inside base.SendAsync, so its Retry-After waits land in
                    // HttpMs while RetryDelayMs counts only the Polly waits outside
