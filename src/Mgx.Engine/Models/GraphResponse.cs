...
/// <summary>Generic wrapper for OData collection responses from Microsoft Graph.</summary>
...
/// <summary>Raw JSON collection response for deserialization before model binding.</summary>
...
/// <summary>Batch request body for /$batch endpoint.</summary>
...
/// <summary>Result of a batch execution including per-item results and operational telemetry.</summary>
